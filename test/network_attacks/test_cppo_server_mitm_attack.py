...
def launch_arp_poison_mock(mocker):
    return mocker.patch('dhalsim.network_attacks.cppo_server_mitm_attack.launch_arp_poison', return_value=None)


@pytest.fixture
def restore_arp_mock(mocker):
    return mocker.patch('dhalsim.network_attacks.cppo_server_mitm_attack.restore_arp', return_value=None)
